                ...
                {{-- <td class="pl-4 pr-1">
                    @if ($artist->discogs)
                        <a href="{{ $artist->discogs_url }}" target="_blank">
                            <img src="https://img.icons8.com/ios-filled/32/2d3748/music-record.png" class="inline h-5">
                        </a>
                    @endif
                </td>
                <td class="px-2">
                    @if ($artist->imdb)
                        <a href="{{ $artist->imdb_url }}" target="_blank">
                            <img src="https://img.icons8.com/windows/32/2d3748/imdb.png" class="inline h-5">
                        </a>
                    @endif
                </td>
                <td class="pl-1">
                    @if ($artist->wikipedia)
                        <a href="{{ $artist->wikipedia_url }}" target="_blank">
                            <img src="https://img.icons8.com/windows/32/2d3748/wikipedia.png" class="inline h-5">
                        </a>
                    @endif
                </td> --}}
            </a>
