    ...
    <div class="space-y-3 mb-8 flex flex-col items-center">
        ...
        @foreach ($artists as $artist)
            <a href="{{ route('artists.show', $artist) }}" wire:key="{{ $artist->id }}"
                class="w-full h-12 sm:h-14 flex items-center bg-gray-100 rounded-lg shadow-lg overflow-hidden">
                <div class="flex-none relative bg-gray-700 bg-cover h-12 w-12 sm:h-14 sm:w-14"
