...
class StoreArtist extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'photo_crop.face.x' => ['integer', 'required_with:photo,photo_uri'],
            'photo_crop.face.y' => ['integer', 'required_with:photo,photo_uri'],
            'photo_crop.face.size' => ['integer', 'required_with:photo,photo_uri'],
            'photo_crop.image.x' => ['integer', 'required_with:photo,photo_uri'],
            'photo_crop.image.y' => ['integer', 'required_with:photo,photo_uri'],
            'photo_crop.image.width' => ['integer', 'required_with:photo,photo_uri'],
            'photo_crop.image.height' => ['integer', 'required_with:photo,photo_uri'],
            'photo_grayscale' => ['boolean', 'required_with:photo,photo_uri'],
