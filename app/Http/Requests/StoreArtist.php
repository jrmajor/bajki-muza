...
class StoreArtist extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'photo_crop.face.x' => ['integer', 'nullable'],
            'photo_crop.face.y' => ['integer', 'nullable'],
            'photo_crop.face.size' => ['integer', 'nullable'],
            'photo_crop.image.x' => ['integer', 'nullable'],
            'photo_crop.image.y' => ['integer', 'nullable'],
            'photo_crop.image.width' => ['integer', 'nullable'],
            'photo_crop.image.height' => ['integer', 'nullable'],
